...
while True:
        ...
        if(cylinder_weight>0 and cylinder_weight<=3):
                ...
                status="empty"
                if(cyl_empty==0):
                        querystring = {"authorization":"CEBM7ZYzfkWlyPrtnmJNoH3xAGFLjhsX06ceg5UuiqQp2dS4RVMpPyG0vdxQOq5N1ktTiLhrERac6wWU","sender_id":"FSTSMS","message":"The cylinder is empty","language":"english","route":"p","numbers":"7541057457,9952162247,7530015671,9500377352"}
        ...
        if(jar_weight>0 and jar_weight<=300):
                ...
                jar_status="empty"
                if(jar_empty==0):
                        querystring = {"authorization":"CEBM7ZYzfkWlyPrtnmJNoH3xAGFLjhsX06ceg5UuiqQp2dS4RVMpPyG0vdxQOq5N1ktTiLhrERac6wWU","sender_id":"FSTSMS","message":"The jar is empty","language":"english","route":"p","numbers":"7541057457,9952162247,7530015671,9500377352"}
                        headers = {'cache-control': "no-cache"}
                        response = requests.request("GET", url, headers=headers, params=querystring)
                        print(response.text)
                        jar_empty=1
        ...
        if(gasleak==40):
                ...
                querystring = {"authorization":"CEBM7ZYzfkWlyPrtnmJNoH3xAGFLjhsX06ceg5UuiqQp2dS4RVMpPyG0vdxQOq5N1ktTiLhrERac6wWU","sender_id":"FSTSMS","message":"There is a gas leak","language":"english","route":"p","numbers":"7541057457,9952162247,7530015671,9500377352"}
                headers = {'cache-control': "no-cache"}
                response = requests.request("GET", url, headers=headers, params=querystring)
                print(response.text)
                jar_empty=1
